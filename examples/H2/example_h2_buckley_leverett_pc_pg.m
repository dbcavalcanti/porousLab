%% DESCRIPTION
%
% Buckley-Leverett problem using the Pc-Pg two-phase flow formulation.
%
% Physics:
...
mdl.setCapillaryPressureDirichletBCAtBorder('left', 0.230769231);
mdl.setGasPressureDirichletBCAtBorder('left', 200000.230769231);

% Set initial conditions
mdl.setInitialCapillaryPressureAtDomain(3.0);
...
mdl.plotGasPressureAlongSegment(Xi, Xf, 500, 'x');
mdl.plotCapillaryPressureAlongSegment(Xi, Xf, 500, 'x');
